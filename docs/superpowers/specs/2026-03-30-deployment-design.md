...
[1/5] P4 서버 설정
  P4 서버 주소 (예: ssl:p4server:1666): perforce.example.com:1666
  P4 계정: CODE
  P4 비밀번호: ****
  P4 Stream (예: //depot/main): //depot/dev

  연결 테스트 중... OK (virtual stream 감지: parent=//depot/main, excludes=6개)
...
├──────────────────────┼──────────┼───────────────────┼────────────┼──────────┤
│ p4gitsync-devmini    │ ● 실행중 │ //depot/dev  │ 12345     │ 2일 3시간│
│ p4gitsync-main       │ ○ 중지   │ //depot/main     │ 280100     │ -        │
└──────────────────────┴──────────┴───────────────────┴────────────┴──────────┘
```
...
서비스: p4gitsync-devmini
  상태:        ● 실행중 (PID 6668)
  Config:      d:\p4gitsync\config-devmini.toml
  Stream:      //depot/dev (virtual → //depot/main)
  방향:        bidirectional
  Git repo:    d:\Projects\project.git
  Last CL:     12345
  총 Commit:   864
  LFS:         활성화 (16 확장자)
  가동시간:    2일 3시간 15분
